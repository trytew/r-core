...
//! |   Thread A2 stack                                           |
//! |-------------------------------------------------------------|
//! | TrapContext Region A                                        |
//! |   TrapContext A2 (tid=1)                                    |
//! |   TrapContext A1 (tid=0)                                    |
//! |-------------------------------------------------------------|
//! | █████ TRAMPOLINE （固定虚拟地址，实际上物理地址是同一个） █████     |
//! |-------------------------------------------------------------|
...
//! |   Thread B2 stack                                           |
//! |-------------------------------------------------------------|
//! | TrapContext Region B                                        |
//! |   TrapContext B2 (tid=1)                                    |
//! |   TrapContext B1 (tid=0)                                    |
//! |-------------------------------------------------------------|
//! | █████ TRAMPOLINE （固定虚拟地址，实际上物理地址是同一个） █████     |
//! |-------------------------------------------------------------|
...
//!                          KERNEL SPACE
//! |-------------------------------------------------------------|
//! | kernel code / trap handler / scheduler                      |
//! |                                                             |
//! | Task struct A                                               |
//! | Task struct B                                               |
//! |                                                             |
//! | Thread A1 kernel stack → TaskContext A1                     |
//! | Thread A2 kernel stack → TaskContext A2                     |
//! | Thread B1 kernel stack → TaskContext B1                     |
//! | Thread B2 kernel stack → TaskContext B2                     |
//! |-------------------------------------------------------------|
//! | 0xffff_ffff_ffff_ffff                                       |
//! ```
